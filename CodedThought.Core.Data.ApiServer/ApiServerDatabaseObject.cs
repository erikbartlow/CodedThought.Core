...
namespace CodedThought.Core.Data.ApiServer {
	...
	public class ApiServerDatabaseObject : DatabaseObject {

		public ApiServerDatabaseObject(string connectionString)
			: base(DBSupported.ApiServer, connectionString) {
		}

		/// <summary>Posts to the Api with the given parameters and payload.</summary>
		...
		protected ApiToken Authenticate(string username, string password) {
			throw new NotImplementedException();
		}
		...
		public override Type ToSystemType(string dbTypeName) {
			throw new NotImplementedException();
		}
