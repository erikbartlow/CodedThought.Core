...
namespace CodedThought.Core.Configuration {
	...
	public static class CoreCoreSettingsExtensions {
        ...
        public static CoreConnectionSetting GetHPCorePrimaryConnectionString(this IConfiguration configuration) {
		...
		public static CoreConnectionSetting GetDatabaseConnection(this IConfiguration configuration, string name) {
			CoreSettings options = new();
			configuration.GetSection(nameof(CoreSettings)).Bind(options);
