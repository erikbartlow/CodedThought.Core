namespace CodedThought.Core.Data.ExcelSystem {
	...
	/// <summary>The ExcelReader Factory</summary>
	public static class ExcelReaderFactory {

		/// <summary>Creates an instance of <see cref="ExcelBinaryReader" /></summary>
		...
		/// <summary>Creates an instance of <see cref="ExcelOpenXmlReader" /></summary>
		/// <param name="fileStream">The file stream.</param>
		/// <returns></returns>
