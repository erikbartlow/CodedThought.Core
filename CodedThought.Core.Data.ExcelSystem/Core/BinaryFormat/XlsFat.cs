...
{
    /// <summary>Represents Excel file FAT table</summary>
    internal class XlsFat
    {
        ...
        /// <summary>Constructs FAT table from list of sectors</summary>
        ...
        public XlsFat(XlsHeader hdr, List<uint> sectors, int sizeOfSector, bool isMini, XlsRootDirectory rootDir)
        {
            ...
            using (MemoryStream ms = new(sizeOfSector * m_sectors_for_fat))
            {
                lock (file)
                {
        ...
        /// <summary>Resurns number of sectors used by FAT itself</summary>
        public int SectorsForFat => m_sectors_for_fat;

        /// <summary>Returns number of sectors described by FAT</summary>
        public int SectorsCount => m_sectors;

        /// <summary>Returns underlying XlsHeader object</summary>
        public XlsHeader Header => m_hdr;

        /// <summary>Returns next data sector using FAT</summary>
        ...
        public uint GetNextSector(uint sector)
        {
            ...
            return value == (uint) FATMARKERS.FAT_FatSector || value == (uint) FATMARKERS.FAT_DifSector
