...
{
    /// <summary>Represents a cell containing formula</summary>
    internal class XlsBiffFormulaCell : XlsBiffNumberCell
    {
        ...
        /// <summary>Formula flags</summary>
        public FormulaFlags Flags => (FormulaFlags) (base.ReadUInt16(0xE));

        /// <summary>Length of formula string</summary>
        public byte FormulaLength => base.ReadByte(0xF);

        /// <summary>Returns type-dependent value of formula</summary>
                ...
                if (((ulong) val & 0xFFFF000000000000) == 0xFFFF000000000000)
                {
                    ...
                    switch (type)
                    {
                        case 0: // String
                            ...
                            str = rec.ID == BIFFRECORDTYPE.SHRFMLA
                                ? GetRecord(m_bytes, (uint) (Offset + Size + rec.Size), reader) as XlsBiffFormulaString
                                : rec as XlsBiffFormulaString;
                            //////////////fix
