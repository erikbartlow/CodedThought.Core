...
{
    /// <summary>Represents Root Directory in file</summary>
    internal class XlsRootDirectory
    {
        ...
        /// <summary>Creates Root Directory catalog from XlsHeader</summary>
        /// <param name="hdr">XlsHeader object</param>
        public XlsRootDirectory(XlsHeader hdr)
        {
            XlsStream stream = new(hdr, hdr.RootDirectoryEntryStart, false, null);
            byte[] array = stream.ReadStream();
            byte[] tmp;
            XlsDirectoryEntry entry;
            List<XlsDirectoryEntry> entries = new();
        ...
        /// <summary>Returns all entries in Root Directory</summary>
        public ReadOnlyCollection<XlsDirectoryEntry> Entries => m_entries.AsReadOnly();

        /// <summary>Returns the Root Entry</summary>
        public XlsDirectoryEntry RootEntry => m_root;

        /// <summary>Searches for first matching entry by its name</summary>
