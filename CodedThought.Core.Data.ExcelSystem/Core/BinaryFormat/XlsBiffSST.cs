...
{
    /// <summary>Represents a Shared String Table in BIFF8 format</summary>
    internal class XlsBiffSST : XlsBiffRecord
    {
        ...
        /// <summary>Returns count of strings in SST</summary>
        public uint Count => base.ReadUInt32(0x0);

        /// <summary>Returns count of unique strings in SST</summary>
        public uint UniqueCount => base.ReadUInt32(0x4);

        /// <summary>Reads strings from BIFF stream into SST array</summary>
        public void ReadStrings()
        {
            ...
            while (offset < last)
            {
                XlsFormattedUnicodeString str = new(m_bytes, offset);
        ...
        /// <summary>Returns string at specified index</summary>
        ...
        {
            return SSTIndex < m_strings.Count ? m_strings[(int) SSTIndex] : string.Empty;
        }

        /// <summary>Appends Continue record to SST</summary>
