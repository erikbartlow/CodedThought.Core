...
namespace CodedThought.Core.Data
{
    ...
    /// </summary>
    public abstract class DatabaseObject : IDatabaseObject, IDbSchema
    {
        ...
        /// <summary>
        /// Gets the DatabaseObject from the DI Service Provider and stores it in the Http Cache.
        /// </summary>
        ...
        //          CoreConnection = connectionSetting;
        //      }
        ...
        /// </summary>
        public virtual IDbConnection Connection => _connection == null
                    ? throw new NullReferenceException("The connection is not initialized.")
                    : _connection;

        /// <summary>Get and set a IDataReader CommandBehavior</summary>
        public CommandBehavior DataReaderBehavior { get; set; } = CommandBehavior.Default;
        ...
        private void DatabaseObject_BulkCopySqlRowsCopied(object sender, SqlRowsCopiedEventArgs e) => throw new NotImplementedException();
        ...
        /// <returns></returns>
        public virtual string ParameterConnector { get; set; }

        /// <summary>Gets the wild card character.</summary>
        /// <value>The wild card character.</value>
        public virtual string WildCardCharacter { get; set; }
        ...
        */
        ...
        /// <summary>
        /// Get's the expected full table name from the passed schema and table names depending on the database provider.  
        /// It should be implemented in the provider specific components.  Otherwise the simple table name will be returned with no
        /// additional formatting or added schema information.
        /// </summary>
        /// <param name="tableName"></param>
        /// <returns>Default format is [schema].[table]</returns>
        ...
        /// <summary>
        /// Converts a database type name to a Core <see cref="DbTypeSupported" /> type.
        /// </summary>
        /// <param name="dbTypeName"></param>
        /// <returns></returns>
        public abstract DbTypeSupported ToDbSupportedType(string dbTypeName);
        public virtual DbType ToDbType(Type systemType)
        {
            Dictionary<Type, DbType> TypeToDbTypeMap = new Dictionary<Type, DbType>()
    {
        ...
        { typeof(Guid), DbType.Guid }    };
            ...
            if (TypeToDbTypeMap.ContainsKey(systemType))
            {
                return TypeToDbTypeMap[systemType];
            }
        ...
        /// </summary>
        /// <returns></returns>
		public abstract string GetTableListQuery();
        /// <summary>
        /// Gets the query used to list all views in the database.
        /// </summary>
        /// <returns></returns>
        public abstract string GetViewListQuery();
        public abstract List<TableColumn> GetTableDefinition(string tableName);
        public abstract List<TableColumn> GetViewDefinition(string viewName);
        public abstract List<TableSchema> GetTableDefinitions();
        public abstract List<ViewSchema> GetViewDefinitions();
        /// <summary>
        ...
        public IDataReader Get(string tableName, List<string> selectColumns, ParameterCollection parameters) => Get(tableName, DefaultSchemaName, selectColumns, parameters, null);

        /// <summary>Gets an IDataReader this creates a simple query where all parameters are joined by 'AND'</summary>
        public IDataReader Get(string tableName, string schemaName, List<string> selectColumns, ParameterCollection parameters) => Get(tableName, schemaName, selectColumns, parameters, null);
        ...
        /// <returns></returns>
        public virtual IDataReader Get(string tableName, List<string> selectColumns, ParameterCollection parameters, List<string> orderByColumns) => Get(tableName, string.Empty, selectColumns, parameters, orderByColumns);
        ...
        public virtual int ExecuteNonQuery(string commandText) => ExecuteNonQuery(commandText, CommandType.Text, null);

        /// <summary>Executes a command in the database which returns no data</summary>
        /// <param name="commandText"></param>
        /// <param name="type">       </param>
        public virtual int ExecuteNonQuery(string commandText, CommandType type) => ExecuteNonQuery(commandText, type, null);

        /// <summary>Executes a command in the database which returns no data</summary>
        /// <param name="commandText"></param>
        /// <param name="parameters"> </param>
        public virtual int ExecuteNonQuery(string commandText, ParameterCollection parameters) => ExecuteNonQuery(commandText, CommandType.Text, parameters);
        ...
        /// <param name="commandText"></param>
        /// <returns></returns>
        public virtual IDataReader ExecuteReader(string commandText) => ExecuteReader(commandText, CommandType.Text, null);

        /// <summary>Executes a command in the database which returns data as a IDataReader implementation</summary>
        /// <param name="commandText"></param>
        /// <param name="type">       </param>
        /// <returns></returns>
        public virtual IDataReader ExecuteReader(string commandText, CommandType type) => ExecuteReader(commandText, type, null);

        /// <summary>Executes a command in the database which returns data as a IDataReader implementation</summary>
        /// <param name="commandText"></param>
        /// <param name="parameters"> </param>
        /// <returns></returns>
        public virtual IDataReader ExecuteReader(string commandText, ParameterCollection parameters) => ExecuteReader(commandText, CommandType.Text, parameters);
        ...
        {
            DataSet ds = ExecuteDataSet(commandText, CommandType.Text, null);
        ...
        /// <param name="commandText"></param>
        /// <returns></returns>
        public virtual DataSet ExecuteDataSet(string commandText) => ExecuteDataSet(commandText, CommandType.Text, null);

        /// <summary>Executes a command in the database which returns data as a DataSet</summary>
        /// <param name="commandText"></param>
        /// <param name="type">       </param>
        /// <returns></returns>
        public virtual DataSet ExecuteDataSet(string commandText, CommandType type) => ExecuteDataSet(commandText, type, null);

        /// <summary>Executes a command in the database which returns data as a DataSet</summary>
        /// <param name="commandText"></param>
        /// <param name="parameters"> </param>
        /// <returns></returns>
        public virtual DataSet ExecuteDataSet(string commandText, ParameterCollection parameters) => ExecuteDataSet(commandText, CommandType.Text, parameters);
        ...
        public virtual void ExecuteBulkCopy_SqlRowsCopied(object sender, SqlRowsCopiedEventArgs e) => BulkCopySqlRowsCopied?.Invoke(this, e);
        ...
        /// <returns></returns>
        public string GenerateColumnList(List<string> columnList) => GenerateColumnList(columnList, "");
        ...
        public virtual string GenerateUpdateList(ParameterCollection parameters)
        {
            ...
            {
                columnSql.Append(__comma + ((IDataParameter) parameters[i]).SourceColumn + " = " + ParameterConnector + parameterCount + i.ToString());
                ...
                foreach (IDataParameter p in parameters)
                {
                    ...
                    switch (p.DbType)
                    {
                        case DbType.AnsiStringFixedLength:
                            sbRealSQL.Replace(ParameterConnector + p.ParameterName, __singleQuote + p.Value.ToString() + __singleQuote);
                        ...
                        case DbType.Int32:
                            if (p.Value.ToString().Length != 0)
                                sbRealSQL.Replace(ParameterConnector + p.ParameterName, p.Value.ToString());
                            else
                                sbRealSQL.Replace(ParameterConnector + p.ParameterName, "NULL");
                            break;
            ...
            for (int i = 0; i <= urlParts.Length - 1; i++)
            {
                ...
                switch (connectionParameter[0])
                {
                    case "Api Url":
                        ...
                        break;
                    case "Controller":
                        controller = connectionParameter[1];
                        break;
                }
            }
