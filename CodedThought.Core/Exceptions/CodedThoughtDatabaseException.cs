...
namespace CodedThought.Core.Exceptions {
	...
	/// </summary>
	[Serializable]
	public class CodedThoughtDatabaseException : ApplicationException, IBaseException {
		...
		public CodedThoughtDatabaseException()
			: base() {
		}

		/// <summary>Constructor that takes a message</summary>
		/// <param name="message"></param>
		public CodedThoughtDatabaseException(string message)
			: base(message) {
		}
		...
		public CodedThoughtDatabaseException(string message, Exception innerException)
			: base(message, innerException) {
		}

		/// <summary>Protected constructor to de-serialize data</summary>
		protected CodedThoughtDatabaseException(SerializationInfo info, StreamingContext context)
			: base(info, context) {
		}
