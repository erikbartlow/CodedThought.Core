...
namespace CodedThought.Core {
    ...
    public static class CacheHelper {
        ...
        public static void AddToLocalCache(this runtime.MemoryCache cache, string key, object val, CacheItemPolicy itemPolicy) {
            cache.Add(key, val, itemPolicy);
        }
        /// <summary>
        ...
        public static void AddToHttpCache(this IMemoryCache cache, string key, object val, MemoryCacheEntryOptions itemPolicy) {
            cache.Set(key, val, itemPolicy);
        }
